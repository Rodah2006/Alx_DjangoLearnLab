...
SECRET_KEY = 'django-insecure-w=_v$31zt2fy2g#bpu3xst8og0+4fw4s8@y_($w)0b8v%3ougs'
...
# We are using Token Authentication so API requests must include a valid token in the Authorization header.
